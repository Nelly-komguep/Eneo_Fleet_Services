...
<div class="main">
  <div class="header">
    ...
    <div class="buttons-group">
      {{-- <a href="../reservation"><button id="openReservationModal" class="btn-add">+ Ajouter une reservation</button></a> --}}
...
<a href="{{ route('dashboard.user.statut', 'validee') }}" style="text-decoration: none;">
    <div class="card" style="background-color:#d0f0c0;">
...
<a href="{{ route('dashboard.user.statut', 'rejetee') }}" style="text-decoration: none;">
    <div class="card" style="background-color:#d0f0c0;">
...
<a href="{{ route('dashboard.user.statut', 'en cours') }}" style="text-decoration: none;">
    <div class="card" style="background-color:#d0f0c0;">
